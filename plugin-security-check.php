...
function psc_get_client_ip() {
    $ip = '';
    // Security Fix: Do not trust HTTP_CLIENT_IP or HTTP_X_FORWARDED_FOR
    // as they can be easily spoofed by attackers to bypass IP bans.
    // Exclusively rely on REMOTE_ADDR for accurate client IP identification.
